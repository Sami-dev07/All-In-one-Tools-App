...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    private List<TodoListMainActivity.Data> mTaskList;
    ...
    public TaskAdapter(Context context, List<TodoListMainActivity.Data> taskList) {
        mContext = context;
        mTaskList = taskList;
    }
    ...
    public void onBindViewHolder(@NonNull TaskViewHolder holder, int position) {
        TodoListMainActivity.Data currentItem = mTaskList.get(position);
