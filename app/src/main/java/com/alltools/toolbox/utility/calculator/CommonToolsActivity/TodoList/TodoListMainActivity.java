package com.alltools.toolbox.utility.calculator.CommonToolsActivity.TodoList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new TaskAdapter.OnItemClickListener() {
            ...
            public void onEditClick(int position) {
                Intent intent = new Intent(TodoListMainActivity.this, editTask.class);
            ...
            public void onDeleteClick(int position) {
                ...
                Toast.makeText(TodoListMainActivity.this, "Task Deleted", Toast.LENGTH_SHORT).show();
            ...
            public void onCheckboxClick(int position) {
                ...
                markTaskAsComplete(position);
                taskData.remove(position);
                Toast.makeText(TodoListMainActivity.this, "Task Completed", Toast.LENGTH_SHORT).show();
                adapter.notifyItemRemoved(position);
            }
        });
        ...
        fabAddTask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TodoListMainActivity.this, AddTaskActivity.class);
                startActivity(intent);
            }
        });
