...
import com.alltools.toolbox.utility.calculator.MathAndFinanceActivities.BubbleLever.widget.AccelerometerView
import com.alltools.toolbox.utility.calculator.R

class MainActivityBubble : AppCompatActivity(), SensorEventListener {
    ...
    private fun startSensors() {
        ...
        if (gravitySensor == null || magneticSensor == null) {
            ...
            sensorManager?.apply {
                registerListener(this@MainActivityBubble, gravitySensor, SensorManager.SENSOR_DELAY_NORMAL)
                registerListener(this@MainActivityBubble, magneticSensor, SensorManager.SENSOR_DELAY_NORMAL)
            }
        }
    }
